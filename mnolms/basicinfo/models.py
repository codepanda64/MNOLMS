...
class Net(models.Model):
    ...
    status = models.SmallIntegerField(choices=net_status, default=0, verbose_name="台网状体")
...
class Station(models.Model):
    ...
    status = models.SmallIntegerField(choices=station_status, default=0, verbose_name="台站状态")
    describe = models.CharField(max_length=512, verbose_name="台站描述")
...
class Caretaker(models.Model):
    ...
    status = models.SmallIntegerField(choices=caretake_status, verbose_name="状态")
