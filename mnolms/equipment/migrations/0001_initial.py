# Generated by Django 2.0 on 2018-06-03 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network_device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='equipment.NetworkDevice', verbose_name='网络设备型号')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='network_device_item', to='seisnet.Station', verbose_name='所属台站')),
            ],
        ),
        migrations.CreateModel(
            name='PowerSupply',
